...
struct thread
  {
    ...
    //Alex Roman
    int initial_priority;               /* Priority before donation occurs. */
    struct list donation_list;          /* The list of threads waiting on lock  this threads holds. */
    struct lock *blocking_lock;         /* Lock that is blocking this thread. */
    struct list_elem donation_elem;     /* Donation element */
    bool donated;                       /* Flag to track priority donation. */
